...
class PatientForm(Form):
    ...
    termsAgreement = CustomBooleanField(_(u'I agree with the Terms of Service').decode("UTF-8"), [validators.Required(message=_(u'You must accept the terms to book an appointment').decode("UTF-8"))])
